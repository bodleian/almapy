...
### Tests
- **utils**: rewrite test_utils.py with niquests types
- **client**: rewrite test_client.py with niquests rsps fixtures
...
### Documentation
- **logging**: document structured extra fields and structlog integration
- document structured logging and correlation IDs
